...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            commands::actualizaciones::informe_de_actualizaciones,
            commands::actualizaciones::aviso_de_actualizaciones_activo,
            commands::actualizaciones::activar_aviso_de_actualizaciones,
            commands::actualizaciones::intervalo_de_comprobacion,
            commands::actualizaciones::poner_intervalo_de_comprobacion,
            commands::aplicaciones_por_defecto::candidatas_para,
            commands::aplicaciones_por_defecto::terminales_disponibles,
            commands::aplicaciones_por_defecto::aplicacion_por_defecto,
            commands::aplicaciones_por_defecto::definir_aplicacion,
            commands::aplicaciones_por_defecto::terminal_por_defecto,
            commands::aplicaciones_por_defecto::definir_terminal,
            ...
            commands::dav_discover::discover_dav,
            ...
            commands::permissions::list_blocked,
            commands::permissions::allow_blocked,
            commands::permissions::dismiss_blocked,
            commands::permissions::list_allowed,
            commands::permissions::revoke_blocked,
